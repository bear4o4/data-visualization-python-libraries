...
def data_scientists_who_like(target_interest):
    ...
    for user_id, interest in interests:
        # Check if the interest matches the target interest
...
# Example usage
print(data_scientists_who_like("Python"))  # Output: [2, 3, 5]
print(data_scientists_who_like("Big Data"))  # Output: [6, 8, 9]